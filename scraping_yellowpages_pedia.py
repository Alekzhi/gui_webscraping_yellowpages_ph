...
class YellowPagesPhScraper:
    def __init__(self):
        ...
        self.search_what_trimmed = "pedia" # Lower case version and without spaces
        self.search_what = "Pedia"
        ...
        self.tuple_not_pedia = [
            ...
            "fabric", "rubber", "marine", "ship", "insular", "pharma",
        ]
